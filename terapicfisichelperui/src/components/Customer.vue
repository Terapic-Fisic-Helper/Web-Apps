        ...
        methods: {
            ...
            deleteItem(item) {
                ...
                if(confirm('¿Estás seguro que quieres eliminar este Customer?'))
                    axios.delete('api/Customers/' + item.id, {
                        'id': item.id
            ...
            isValidName() {
                ...
                if(this.description.length < 3 || this.description.length > 255) {
                    this.validMessage.push("La Descripción debe tener mas de 3 caracteres y menos de 255 caracteres");
                }
